...
public class CreateOrderCommandValidator : AbstractValidator<CreateOrderCommand>
{
    public CreateOrderCommandValidator()
    {
        ...
        RuleFor(x => x.Transport).NotNull().SetValidator(new TransportDtoValidator());
        RuleForEach(x => x.Payloads).SetValidator(new PayloadDtoValidator());
        RuleForEach(x => x.RoutePoints).SetValidator(new RoutePointDtoValidator());
    }
}